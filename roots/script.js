    ...
    function squareRoots(a,b,c) {
        let d=b*b-4*a*c; // дискриминант квадратного уравнения
        ...
        if ( a==0 )
        return [-c/b]; // уравнение не квадратное и корень находится по-другому. Это и есть ошибка 
